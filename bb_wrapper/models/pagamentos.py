...
ERROS_VALIDACAO_PAGAMENTO_DICT = {
    ...
    3: "Dígito conta de crédito igual a espaços. Informe o DV da conta de crédito.",  # noqa
    ...
    10: "Ambos os campos Número Compensação e Número ISPB estão zerados. Informe um dos campos.",  # noqa
    11: "Ambos os campos Número Compensação e Número ISPB foram informados. Informe apenas um dos campos.",  # noqa
    12: "Ambos os campos Finalidade DOC e Finalidade TED estão zerados. Informe um dos campos.",  # noqa
    13: "Ambos os campos Finalidade DOC e Finalidade TED foram informados. Informe apenas um dos campos.",  # noqa
    14: "Número depósito judicial igual a espaços.",
    15: "Digito da conta de crédito inválido.",
    16: "Ambos os campos CPF e CNPJ foram informados. Informe apenas um dos campos.",  # noqa
    # Caso informado os 2 campos, nas consultas será exibido apenas os dados do CPF.  # noqa
    ...
    20: "Agência e conta de crédito estão iguais a de débito. Opção não permitida.",  # noqa
    21: "Número Compensação inválido. Verifique o dado informado.",
    22: "Número ISPB diferente de zeros. Não informe o nº ISPB.",
    23: "Conta de crédito igual a zeros. Informe o número da conta de crédito.",  # noqa
    24: "CPF igual a zeros. Obrigatório informar o nº do CPF.",
    25: "CNPJ diferente de zeros. Não permitido informar CNPJ.",
    26: "Conta de crédito diferente de zeros. Não permitido informar Conta de crédito.",  # noqa
    ...
    35: "Conta de poupança não permitido. Para creditar poupança utilize Código Produto igual a 128 - Pagamentos Diversos.",  # noqa
    # noqa
    ...
    41: "Número de inscrição do beneficiário não é numérico. Informar números.",  # noqa
    42: "Número de inscrição do avalista não é numérico. Informar números.",
    43: "Digito do CPF para o pagador inválido. Verifique o nº correto.",
    44: "Digito do CPF para o beneficiário inválido. Verifique o nº correto.",
    45: "Digito do CPF para o avalista inválido. Verifique o nº correto.",
    46: "Digito do CNPJ para o pagador inválido. Verifique o nº correto.",
    47: "Digito do CNPJ para o beneficiário inválido. Verifique o nº correto.",
    48: "Digito do CNPJ para o avalista inválido. Verifique o nº correto.",
    ...
    57: "Número de inscrição do beneficiário não informado. Obrigatório informar o CPF ou CNPJ do beneficiário.",  # noqa
    58: "Conta pagamento diferente de espaços. Não informar conta pagamento.",
    59: "Ambos os campos conta de crédito e conta pagamento foram informados. Informar apenas um dos campos.",  # noqa
    ...
    86: "Ambos os campos agência de crédito e conta pagamento foram informados.",  # noqa
    ...
    114: "Número de inscrição do beneficiário inválido. Informe um número válido.",  # noqa
    ...
    117: "Nº de identifiação do contribuinte DARF inválido. Informe um número válido.",  # noqa
    ...
    122: "Nº de identificação do contribuinte GPS inválido. Informe um número válido.",  # noqa
    123: "Valor previsto do pagamento do INSS inválido. Informe um valor válido.",  # noqa
    ...
    203: "Controle Inválido. Verificar campos 01, 02 e 03 do header ou segmento A, B, C, J, J52, N, O ou W do Arquivo CNAB240.",  # noqa
    204: "Tipo de Operação Inválido.",
    205: "Tipo de Serviço Inválido.",
    # Utilize 126 para Pagamento a Fornecedores, 127 para Pagamento de Salários ou 128 para Pagamentos Diversos.  # noqa
    206: "Forma de Lançamento Inválida.",
    # Para crédito em Poupança utilize Pagamentos Diversos.
    # Para crédito em Conta Pagamento utilize Pagamentos Diversos ou Pagamento a Fornecedores.  # noqa
    # Para Pagamento de salário a conta de crédito deve ser do BB.
    ...
    210: "Nº Seqüencial do Registro no Lote Inválido.",
    211: "Código de Segmento de Detalhe Inválido.",
    212: "Lançamento inconsistente, rejeitado na prévia. Corrigir os dados do lançamento e enviar novo pagamento.",  # noqa
    ...
    222: "Tipo/Número de Inscrição do Favorecido Inválido. CPF ou CNPJ do favorecido inválido.",  # noqa
    ...
    299: "Primeiro nome do mutuário diferente do primeiro nome do movimento do censo ou diferente da base de Titular do Benefício.",  # noqa
    ...
    316: "Não averbação de contrato - quantidade de parcelas/competências informadas ultrapassou a data limite da extinção de cota do dependente titular de benefícios.",  # noqa
    ...
    325: "Divergência entre o primeiro e último nome do beneficiário versus primeiro e último nome na Receita Federal.",  # noqa
    ...
    333: "Limite de pagamentos parciais do boleto excedido. Consulte o Beneficiário do boleto.",  # noqa
    334: "Boleto já liquidado. Não passível de pagamento.",
    335: "Pix não efetivado.",
    336: "Transação interrompida devido a erro no PSP do Recebedor.",
    337: "Número da conta transacional encerrada no PSP do Recebedor.",
    338: "Tipo incorreto para a conta transacional especificada.",
    339: "Tipo de transação não é suportado/autorizado na conta transacional especificada.",  # noqa
    340: "CPF/CNPJ do usuário recebedor não é consistente com o titular da conta transacional especificada.",  # noqa
    341: "CPF/CNPJ do usuário recebedor incorreto.",
    342: "Ordem rejeitada pelo PSP do Recebedor.",
    343: "ISPB do PSP do Pagador inválido ou inexistente.",
    344: "Chave não cadastrada no DICT.",
    345: "QR Code inválido/vencido.",
    346: "Forma de iniciação inválida.",
    347: "Chave de pagamento inválida.",
    348: "Chave de pagamento não informada.",
