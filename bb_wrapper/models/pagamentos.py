...
ERROS_VALIDACAO_PAGAMENTO_DICT = {
    ...
    10: "Ambos os campos Número Compensação e Número ISPB estão zerados. Informe um dos campos.",
    11: "Ambos os campos Número Compensação e Número ISPB foram informados. Informe apenas um dos campos.",
    12: "Ambos os campos Finalidade DOC e Finalidade TED estão zerados. Informe um dos campos.",
    ...
    27: "Dígito conta de crédito diferente de espaços. Não informar dígito da conta de crédito.",
    ...
    30: "Número Depósito Judicial diferente de espaços. Não informar finalidade Depósito Judicial.",
    ...
    35: "Conta de poupança não permitido. Para creditar poupança utilize Código Produto igual a 128 - Pagamentos Diversos.",
    ...
    57: "Número de inscrição do beneficiário não informado. Obrigatório informar o CPF ou CNPJ do beneficiário",
    58: "Conta pagamento diferente de espaços. Não informar conta pagamento.",
    59: "Ambos os campos conta de crédito e conta pagamento foram informados. Informar apenas um dos campos.",
    ...
    117: "Nº de identifiação do contribuinte DARF inválido. Informe um número válido.",
